...
| FR-28 | Validate required Add Pearl fields: name, story, address, theme, latitude, longitude, and PearlOwner | `GH-PRL-01`<br>`GH-PRL-03` | `3 5 UI Design`<br>`3 6 UI ↔ API Mapping`<br>`3 7 API Contracts` | `backend/src/app.ts`<br>`backend/src/modules/admin/pearls.service.ts`<br>`frontend/src/components/admin/AddPearlForm.tsx` | `TC-PRL-API-02`<br>`TC-PRL-UI-02`<br>`TC-PRL-UI-04` | VERIFIED | Backend and frontend validation reject missing/invalid fields and surface backend validation errors |
